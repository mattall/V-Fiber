...
ADEX = {
    ...
    'bindings': ['192.168.57.104:7000', '192.168.57.103:7000', '192.168.57.102:7000']
}

SELLER = {
    # server port combination for distributed seller object
    'bindings': ['192.168.57.104:7100', '192.168.57.103:7100', '192.168.57.102:7100']
}
